...
# gene_cnv_path='/Users/lnguyen//hpc/cog_bioinf/cuppen/project_data/HMF_data/DR-104/data/somatics/161123_HMFregCPCT_FR12244764_FR13275498_CPCT02010422//CPCT02010422T.purple.cnv.gene.tsv'
...
# genes_bed_path='/Users/lnguyen/hpc/cog_bioinf/cuppen/project_data/Luan_projects/CHORD/scripts_main/hmfGeneAnnotation/data/gene_selection/genes.bed'

gene_cnv <- read.delim(gene_cnv_path)
human_genes_enst2ensg <- read.delim(gzfile(GENES_ENST2ENSG), check.names=F)
genes_bed <- read.delim(genes_bed_path, check.names=F)
...
sel_cols <- c(
   'chromosome','start','end','hgnc_symbol','gene','ensembl_gene_id',
